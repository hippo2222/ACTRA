...
def _add_security_headers(response):
    response.headers.setdefault(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.paddle.com https://*.paddle.com https://public.profitwell.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.paddle.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https://upload.wikimedia.org https://*.paddle.com https://*.paddle.io https://*.amazonaws.com; connect-src 'self' https://*.paddle.com https://*.paddle.io https://*.profitwell.com; frame-src 'self' https://*.paddle.com https://checkout.paddle.com https://buy.paddle.com; frame-ancestors 'self'",
    )
