...
def _matrix_entries() -> Dict[str, Dict[str, Any]]:
    return {
        ...
        "open_answer_core": {
            ...
            "level_role_map": [
                {"level": 1, "role": "Базовый открытый ответ: идентификация и первичное описание"},
                {"level": 2, "role": "Аналитический ответ: разбор признаков, механизмов и взаимосвязей"},
                {"level": 3, "role": "Комплексный клинический ответ: дифференциальная диагностика и обоснование решений"},
            ],
        },
        "image_labeling_core": {
...
def _simplify_level_role_map(
    ...
    simple_roles: Dict[str, Dict[int, str]] = {
        ...
        "OPEN_ANSWER": {
            1: "Пользователь формулирует базовый развернутый ответ на вопрос.",
            2: "Пользователь проводит аналитический разбор признаков и взаимосвязей.",
            3: "Пользователь формулирует комплексный клинический ответ и дифференциальную диагностику.",
        },
    }
