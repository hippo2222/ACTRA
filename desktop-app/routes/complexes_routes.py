...
def create_complex() -> Any:
    ...
    try:
        ...
        complex_data = {
            ...
            "theory_blocks": normalized.get("theory_blocks", {}),
            "theory_block_ranges": normalized.get("theory_block_ranges", []),
            "theory_block_versions": normalized.get("theory_block_versions", {}),
            "task_block_mappings": normalized.get("task_block_mappings", {}),
