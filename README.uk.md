...
ACTRA виходить за рамки звичайного текстового введення та пропонує **6 унікальних типів практичних завдань**, що оцінюються бекенд-алгоритмами в реальному часі:
...
*   **Контрольні точки (Тест)**: Стандартний тест із вибором одного або кількох варіантів відповідей, підтримкою кількох правильних відповідей, додаванням зображень у сам процес запитання (до 3 штук) та у варіанти відповіді. Надає миттєвий зворотний зв'язок та виведення пояснень до помилок.
*   **Пошук помилок (Ошибки)**: Клік по конкретних словах або текстових токенах у блоці тексту, що містить навмисні граматичні, смислові чи фактичні помилки. Бекенд зіставляє індекси обраних слів з еталонним ключем для оцінки правильних та хибних спрацьовувань.
...
ACTRA встановлює чіткий педагогічний міст між практичними наборами (комплексами) та довідковими статтями. Перед початком проходження будь-якого комплексу ви можете відкрити та прочитати пов'язану теоретичну статтю безпосередньо зі сторінки списку комплексів в один клік — це швидкий та зручний спосіб повторити ключові концепції перед початком активної практики.
...
Боріться з кривою забування за допомогою вбудованих колод флеш-карток. Система автоматично планує щоденні повторення на основі історії відповідей користувача, а дашборд здоров'я пам'яті розраховує індекс збереження знань та будує графіки регулярності занять. Підтримується пакетний імпорт флеш-карток із текстових файлів або результатів зовнішнього аналізу. Для дотримання політик безпеки (CSP) пряме вставлення посилань на сторонні зображення заблоковано; однак ви можете забезпечувати картки відкритими ілюстраціями, що безпечно завантажуються через SSRF-захищений серверний проксі з баз **Wikimedia Commons** або **Openverse** (Flickr CC) з автоматичним імпортом даних про авторство.
