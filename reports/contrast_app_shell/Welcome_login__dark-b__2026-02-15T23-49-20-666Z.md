...
| **1.98** | 3.0 min | `h3#loginName.text-3xl.font-black.text-text-` | "Демо профиль" |
...
| Ratio | Required | Element | Text |
|---|---|---|---|
| **1.26** | 3 | `input#loginPassword.w-full.pl-12.pr-12.py-4.bg-sur` | "Border" |

## UI Component Boundary (1 warnings)

| Ratio | Required | Element | Text |
|---|---|---|---|
| **1.04** | 3 | `button.w-full.py-4.bg-primary.text-wh` | "Р’РѕР№С‚Рё РІ СЃРёСЃ" |
