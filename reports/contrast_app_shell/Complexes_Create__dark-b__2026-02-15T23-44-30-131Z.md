...
| Ratio | Required | Element | Text |
|---|---|---|---|
| **1.00** | 1.3+ (visual separation) | `span.px-2.py-0.5.bg-bg-te` | "px-2 py-0.5 bg-bg-tertiary text-text-secondary bor" |
| **1.15** | 1.3+ (visual separation) | `div.w-16.h-16.rounded-fu` | "w-16 h-16 rounded-full bg-primary-lighter flex ite" |
| **1.05** | 1.3+ (visual separation) | `span#add-counter.counter-glass.inline` | "counter-glass inline-flex items-center justify-cen" |
