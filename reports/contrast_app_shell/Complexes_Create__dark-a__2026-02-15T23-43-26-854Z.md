...
| **3.05** | 4.5 min | `label.text-sm.font-medium.` | "Описание" |
| **3.05** | 4.5 min | `label.text-sm.font-medium.` | "Источник теории" |
...
| Ratio | Required | Element | Text |
|---|---|---|---|
| **1.00** | 3 | `input#name.form-field.form-fiel` | "Border" |
| **1.00** | 3 | `textarea#description.form-field.form-fiel` | "Border" |
| **1.00** | 3 | `select#theory-mode.form-field.form-fiel` | "Border" |
| **1.01** | 3 | `div.section-header-premi` | "Border" |
| **1.90** | 3 | `span.px-2.py-0.5.bg-bg-te` | "Border" |
| **1.06** | 3 | `div#selected-empty.bg-bg-secondary.roun` | "Border" |
...
| Ratio | Required | Element | Text |
|---|---|---|---|
| **2.05** | 3 | `input#name.form-field.form-fiel` | "Control" |
| **2.05** | 3 | `select#theory-mode.form-field.form-fiel` | "Не привязывать Новая" |
