(function () {
    ...
    window.ACTRA_ONBOARDING_TOURS = [
            ...
            steps: [
                {
                    ...
                    targets: [
                        ...
                        '[data-global-nav="/ui/catalog"]',
                        '[data-global-nav="/ui/complexes"]'
                    ],
                    placement: 'bottom',
                ...
                },
                {
                    ...
                    targets: [
                        ...
                        '[data-global-nav="/ui/theory-center"]',
                        '[data-global-nav="/ui/editor"]'
                    ],
                    placement: 'bottom',
        ...
        },
        {
            ...
            referenceOrder: 60,
            route: ['/ui/theory-center', '/ui/editor/Theory_Center.html'],
            autoStart: true,
            autoStartDelay: 900,
            totalStates: 2,
            persistControl: true,
        ...
        },
        {
            ...
            referenceOrder: 80,
            route: ['/ui/theory-editor', '/ui/editor/Theory_Editor.html'],
            autoStart: true,
            autoStartDelay: 900,
            totalStates: 3,
            persistControl: true,
        ...
        },
        {
            ...
            referenceOrder: 100,
            route: [
                '/ui/editor/Test%20Task%20Editor%20Multiple%20Choice.html',
                '/ui/editor/Test Task Editor Multiple Choice.html',
                '/ui/editor/Test_Task_Editor_Multiple_Choice.html',
        ...
        },
        {
            ...
            referenceOrder: 110,
            route: ['/ui/editor/Open%20Answer%20Editor%20Textual%20Reasoning.html'],
            autoStart: true,
            autoStartDelay: 900,
            totalStates: 5,
            persistControl: true,
        ...
        },
        {
            ...
            referenceOrder: 120,
            route: ['/ui/editor/Point_Annotation.html', '/Editor/Point_Annotation.html'],
            autoStart: false,
            autoStartDelay: 900,
            totalStates: 6,
            persistControl: true,
        ...
        },
        {
            ...
            referenceOrder: 160,
            route: ['/ui/editor/Sequence%20Assembly%20Editor%20Procedural%20Steps.html'],
            autoStart: true,
            autoStartDelay: 900,
            totalStates: 5,
            persistControl: true,
        ...
        },
        {
            ...
            referenceOrder: 90,
            route: ['/ui/editor', '/ui/editor/Main_Dashboard.html'],
            autoStart: true,
            autoStartDelay: 900,
            totalStates: 5,
            persistControl: true,
