...
class TestPathHelpers:
    ...
    def test_session_file_path(self, repo, tmp_path):
        result = repo._get_session_file_path("complex1", "user1")
...
class TestSaveSession:
    ...
    def test_save_creates_file(self, repo):
        ...
        path = repo._get_session_file_path("c1", "user1")
        assert path.exists()
    ...
    def test_guest_not_persisted(self, repo):
        ...
        assert result is True
        path = repo._get_session_file_path("c1", "guest")
    ...
    def test_user_id_mismatch_uses_session(self, repo):
        ...
        path = repo._get_session_file_path("c1", "real_user")
        assert path.exists()
